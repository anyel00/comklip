  ...
  return (
    <main>
      ...
      <section id="offres" style={{ background: "#0A0A0A", padding: "100px clamp(24px, 5vw, 80px)", textAlign: "center" }}>
        ...
        <h2 className="h2 fade-in" style={{ marginBottom: "64px" }}>6 vidéos. Écrites pour vendre.</h2>
        ...
        <div className="fade-in" style={{ position: "relative", zIndex: 1, background: "linear-gradient(140deg,#0a1f0d 0%,#0d2b12 100%)", border: "1px solid rgba(0,230,118,0.2)", borderRadius: "24px", padding: "clamp(48px,8vw,96px) clamp(32px,6vw,80px)", textAlign: "center", maxWidth: "1300px", margin: "0 auto", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "16px", marginBottom: "40px" }}>
              {/* Instagram */}
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(0,230,118,0.15)", borderRadius: "14px", padding: "16px 28px", backdropFilter: "blur(8px)" }}>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none"><rect x="2" y="2" width="20" height="20" rx="5" stroke="#00E676" strokeWidth="1.5"/><circle cx="12" cy="12" r="4" stroke="#00E676" strokeWidth="1.5"/><circle cx="17.5" cy="6.5" r="1" fill="#00E676"/></svg>
                <span style={{ fontSize: "11px", color: "rgba(245,245,245,0.5)", fontWeight: 600, letterSpacing: "0.04em" }}>Instagram</span>
              </div>
              {/* TikTok */}
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "8px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(0,230,118,0.15)", borderRadius: "14px", padding: "16px 28px", backdropFilter: "blur(8px)" }}>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="#00E676"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z"/></svg>
                <span style={{ fontSize: "11px", color: "rgba(245,245,245,0.5)", fontWeight: 600, letterSpacing: "0.04em" }}>TikTok</span>
              </div>
            </div>
